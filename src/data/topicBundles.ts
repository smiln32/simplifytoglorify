...
export const topicBundles: TopicBundle[] = [
  ...
  { name: 'Faith', image: '/images/topic_faith.webp', description: 'closer to God', slug: 'struggling-with-faith' },
  ...
  { name: 'Trusting God', image: '/images/topic_uncertainty.webp', description: 'in uncertainty', slug: 'uncertainty', imageClass: 'saturate-[55%] brightness-[1.05]' },
];
