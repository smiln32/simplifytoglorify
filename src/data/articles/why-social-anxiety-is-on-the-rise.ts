...
const post: Article = {
  ...
  keywords: [
    ...
    'Christian social anxiety',
    'overcoming social anxiety',
    'social anxiety faith',
    'social anxiety Christian women',
  ],
  image: '/images/social-anxiety-is-on-the-rise.webp',
  body: `If social situations feel harder than they used to, you are not the only one.
