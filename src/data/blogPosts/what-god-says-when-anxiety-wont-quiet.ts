...
const post: BlogPost = {
  ...
  content: `
    ...
    <p>The goal was never to stop feeling anxious. The goal was to know who holds you when the anxiety is loud. And that's a very different thing.</p>

    <h3>Anxiety Is Not a Faith Failure</h3>

    <p>I want to say that plainly because I think a lot of women are carrying shame about their anxiety that they were never supposed to carry. Anxiety is not a sign that you don't trust God enough. It is not evidence of insufficient faith. It is a feature of the human nervous system, shaped by experience, temperament, biochemistry, and sometimes by very real and legitimate threats. The woman who loves God deeply can also struggle with anxiety. Both things are true at the same time.</p>

    <p>The disciples were anxious. The apostle Paul wrote about his own fears and conflicts. The Psalms are full of people crying out from places of genuine distress and worry. Anxiety is not the enemy of faith. Pretending you don't feel it might be closer to the problem.</p>

    <h3>What Scripture Actually Offers</h3>
    ...
    <h3>The Gift of Honest Prayer</h3>

    <p>One of the most practical things I've found helpful in anxious seasons is giving up on organized, coherent prayer and just saying what's actually there.</p>

    <p>"I'm afraid of what's happening with my health and I'm trying not to catastrophize but I keep doing it anyway."</p>
    ...
    <h3>What God Says to the Anxious Heart</h3>

    <p>Isaiah 41:10 is one I come back to again and again: <em>"Do not fear, for I am with you; do not be afraid, for I am your God. I will strengthen you, I will also help you, I will also uphold you with My righteous right hand."</em></p>
