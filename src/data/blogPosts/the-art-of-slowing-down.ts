...
const post: BlogPost = {
  ...
  content: `
    ...
    <blockquote style="border-left: 3px solid #c6b5c8; margin: 2em 0; padding: 1em 2em; background-color: #ffffff; border-radius: 0 8px 8px 0; font-style: italic; color: #4a5568;">
