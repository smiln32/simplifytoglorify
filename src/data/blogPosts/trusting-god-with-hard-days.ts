...
const post: BlogPost = {
  ...
  metaDescription: "Trusting God on a hard day isn't pretending you're fine. A faith-rooted look at honest prayer, leaning on Scripture, and taking the next faithful step.",
  keywords: [
    'trusting God in hard times',
    'trusting God on hard days',
    'faith on difficult days',
    'how to trust God',
