...
export default function FreebiePopup() {
  ...
  return (
    ...
    >
      <div
        className={`relative bg-white rounded-card card-shadow max-w-md w-full p-8 sm:p-10 transition-all duration-200 ${closing ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}
